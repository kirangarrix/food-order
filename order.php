        ...
        <div class="container">
            ...
            <form action="" class="order" method="POST">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g.Mike " class="input-responsive" required>
            ...
            <?php
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        // check query succesfully executed or not
                        if($res2==true){
                            // order saved
                            $_SESSION['order']="<div class='success text-center'>Food Ordererd Successfully</div>";
                            header('location:'.SITEURL);
                        }else{
                            // fail to save order
